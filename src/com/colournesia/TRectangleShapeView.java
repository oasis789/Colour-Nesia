...
public class TRectangleShapeView extends ShapeView {

	private static final int VIEW_ID = 5;
	int NO_OF_RECT = 2;
	private Rect[] rect = new Rect[NO_OF_RECT];

	public TRectangleShapeView(Context context, PaintManager paintManager) {
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		rect[1] = new Rect(w * 3 / 8, h / 4, w * 5 / 8, h * 7 / 8);
		setRect(rect);
